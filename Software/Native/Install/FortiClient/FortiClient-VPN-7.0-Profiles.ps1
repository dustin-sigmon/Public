...
if ($null -ne $VPN_PROFILE) {
    ...
    Invoke-WebRequest -UseBasicParsing -Uri "https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/Configuration-Files/7.0/$($VPN_PROFILE).conf" `
        -OutFile "C:\TempDeploy\FortiClientVPN\VPN.conf" -ErrorAction Continue
    Start-Sleep -Seconds 5

    # Download import batch file
    Invoke-WebRequest -UseBasicParsing -Uri "https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/Configuration-Files/Import-Profile.bat" `
        -OutFile "C:\TempDeploy\FortiClientVPN\Import.bat" -ErrorAction Continue
    Start-Sleep -Seconds 5
    ...
    # Download config file
    Invoke-WebRequest -UseBasicParsing -Uri "https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/Configuration-Files/7.0/QTS.conf" `
        -OutFile "C:\TempDeploy\FortiClientVPN\VPN.conf" -ErrorAction Continue
    Start-Sleep -Seconds 5
