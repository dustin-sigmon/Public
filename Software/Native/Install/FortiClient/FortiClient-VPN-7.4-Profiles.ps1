...
if ($null -ne $VPN_PROFILE) {
    ...
    Invoke-WebRequest -UseBasicParsing -Uri "https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/Configuration-Files/7.4/$($VPN_PROFILE).conf" `
    ...
    # Download config file
    Invoke-WebRequest -UseBasicParsing -Uri "https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/Configuration-Files/7.4/QTS.conf" `
        -OutFile "C:\TempDeploy\FortiClientVPN\VPN.conf" -ErrorAction Continue
    Start-Sleep -Seconds 5
