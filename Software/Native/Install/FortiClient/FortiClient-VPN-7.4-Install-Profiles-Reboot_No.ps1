...
iex (New-Object Net.WebClient).DownloadString('https://source-east-scripts.s3.us-east-va.io.cloud.ovh.us/_Software/FortiClient/FortiClient-VPN-7.4-Install.ps1')
