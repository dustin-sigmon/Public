...
.DESCRIPTION
    ...
    1. Downloads Adobe-Acrobat-Custom-Package-Editor zip file.
    2. Extracts AcroPro.zip to C:\TempDeploy\Adobe-Acrobat-Custom-Package-Editor.
...
$SoftwareName = "Adobe-Acrobat-Custom-Package-Editor"
$JsonUrls = @(
...
try {
    ...
    $downloadDir = "C:\TempDeploy\Adobe-Acrobat-Custom-Package-Editor"
    ...
    if ($DisableInstall) {
        ...
        $iniFilePath = "C:\TempDeploy\Adobe-Acrobat-Custom-Package-Editor\setup.ini"
