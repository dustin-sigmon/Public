...
.DESCRIPTION
    ...
    1. Downloads Adobe-Reader-x64-MUI-Installer zip file.
    2. Extracts AcroPro.zip to C:\TempDeploy\Adobe-Reader-x64-MUI-Installer.
...
$SoftwareName = "Adobe-Reader-x64-MUI-Installer"
$JsonUrls = @(
...
try {
    ...
    $downloadDir = "C:\TempDeploy\Adobe-Reader-x64-MUI-Installer"
    ...
    if ($DisableInstall) {
        ...
        $iniFilePath = "C:\TempDeploy\Adobe-Reader-x64-MUI-Installer\setup.ini"
