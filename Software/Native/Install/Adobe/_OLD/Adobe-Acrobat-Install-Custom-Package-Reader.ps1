...
.DESCRIPTION
    ...
    1. Downloads Adobe-Acrobat-Custom-Package-Reader zip file.
    2. Extracts AcroPro.zip to C:\TempDeploy\Adobe-Acrobat-Custom-Package-Reader.
...
$SoftwareName = "Adobe-Acrobat-Custom-Package-Reader"
$JsonUrls = @(
...
try {
    ...
    $downloadDir = "C:\TempDeploy\Adobe-Acrobat-Custom-Package-Reader"
    ...
    if ($DisableInstall) {
        ...
        $iniFilePath = "C:\TempDeploy\Adobe-Acrobat-Custom-Package-Reader\setup.ini"
