...
.DESCRIPTION
    ...
    1. Downloads Adobe-Acrobat-x64-Installer zip file.
    2. Extracts AcroPro.zip to C:\TempDeploy\Adobe-Acrobat-x64-Installer.
...
$SoftwareName = "Adobe-Acrobat-x64-Installer"
$JsonUrls = @(
...
try {
    ...
    $downloadDir = "C:\TempDeploy\Adobe-Acrobat-x64-Installer"
    ...
    if ($DisableInstall) {
        ...
        $iniFilePath = "C:\TempDeploy\Adobe-Acrobat-x64-Installer\setup.ini"
