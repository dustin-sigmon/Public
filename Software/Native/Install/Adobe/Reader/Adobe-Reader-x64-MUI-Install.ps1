...
.DESCRIPTION
    ...
    1. Downloads Adobe-Reader-x64-MUI-Install zip file.
    2. Extracts AcroPro.zip to C:\TempDeploy\Adobe-Reader-x64-MUI-Install.
...
$SoftwareName = "Adobe-Reader-x64-MUI-Install"
$JsonUrls = @(
...
try {
    ...
    $downloadDir = "C:\TempDeploy\Adobe-Reader-x64-MUI-Install"
    ...
    if ($DisableInstall) {
        ...
        $iniFilePath = "C:\TempDeploy\Adobe-Reader-x64-MUI-Install\setup.ini"
