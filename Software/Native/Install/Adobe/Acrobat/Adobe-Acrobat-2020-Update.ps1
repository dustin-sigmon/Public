...
<#
.SYNOPSIS
    Downloads and installs Adobe-Acrobat-2020-Update using data from Software-Versions.json
    
.DESCRIPTION
    This script downloads and installs Adobe-Acrobat-2020-Update following these steps:
    1. Checks if Adobe-Acrobat-2020-Update is already installed and compares version
    ...
    5. Installs Adobe-Acrobat-2020-Update with specified arguments
...
$SoftwareName = "Adobe-Acrobat-2020-Update"
$JsonUrls = @(
...
try {
    Write-ColorOutput "=== Adobe-Acrobat-2020-Update Installation Script ===" "Cyan"
    if ($DisableInstall) {
    ...
    Write-ColorOutput "Starting Adobe-Acrobat-2020-Update installation process..." "White"
    ...
    Write-ColorOutput "Checking if Adobe-Acrobat-2020-Update is already installed..." "White"
    ...
    if ($installedVersion) {
        ...
        if (-not $needsUpdate) {
            Write-ColorOutput "Adobe-Acrobat-2020-Update is already up to date. No installation needed." "Green"
            return 0
        }
        else {
        ...
        Write-ColorOutput "Adobe-Acrobat-2020-Update not found. Proceeding with installation..." "Yellow"
    }
    ...
    # Handle version conversion for Adobe-Acrobat-2020-Update (remove decimal point)
    ...
    if (-not $downloadSuccess) {
        throw "Failed to download Adobe-Acrobat-2020-Update installer after $($maxRetries + 1) attempts"
    }
    ...
    if (-not [string]::IsNullOrWhiteSpace($softwareConfig.processes)) {
        Write-ColorOutput "Killing specified Adobe-Acrobat-2020-Update processes..." "White"
        if ($DisableInstall) {
    ...
    # Install software
    Write-ColorOutput "Installing Adobe-Acrobat-2020-Update..." "White"
    ...
    while (-not $installSuccess -and $installRetryCount -le $maxInstallRetries) {
        ...
        try {
            if ($DisableInstall) {
                Write-ColorOutput "[DRY-RUN] Would install Adobe-Acrobat-2020-Update with msiexec /p: $downloadPath $($softwareConfig.arguments)" "Cyan"
                $installSuccess = $true
            }
            else {
            ...
            if ($DisableInstall) {
                ...
                Write-ColorOutput "Adobe-Acrobat-2020-Update installation error: $($_.Exception.Message)" "Red"
    ...
    if (-not $installSuccess) {
        Write-ColorOutput "Adobe-Acrobat-2020-Update installation failed after $($maxInstallRetries + 1) attempts. Leaving installer in: $downloadDir" "Red"
        throw "Adobe-Acrobat-2020-Update installation failed"
    }
    
    # Verify software installation
    Write-ColorOutput "Verifying Adobe-Acrobat-2020-Update installation..." "White"
    
    if ($DisableInstall) {
        Write-ColorOutput "[DRY-RUN] Would verify Adobe-Acrobat-2020-Update installation" "Cyan"
        ...
        Write-ColorOutput "=== Adobe-Acrobat-2020-Update Installation Completed Successfully (DRY-RUN) ===" "Green"
        return 0
    }
    else {
        ...
        if ($installationVerified -and $versionMatch) {
            Write-ColorOutput "Adobe-Acrobat-2020-Update installation and version verification successful" "Green"
            ...
            Write-ColorOutput "=== Adobe-Acrobat-2020-Update Installation Completed Successfully ===" "Green"
            return 0
        } else {
            Write-ColorOutput "Adobe-Acrobat-2020-Update installation or version verification failed" "Red"
            Write-ColorOutput "Leaving installer in: $downloadDir" "Yellow"
            throw "Adobe-Acrobat-2020-Update installation or version verification failed"
        }
    }
}
catch {
    Write-ColorOutput "=== Adobe-Acrobat-2020-Update Installation Failed ===" "Red"
